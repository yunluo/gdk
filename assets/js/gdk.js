...
/**展示密码可见内容 */
function show_pass_content(a){
	$(".pass_viewbox").hide();
	$(".pass_viewbox").after("<div class='content-hide-tips'><span class='rate label label-warning'>隐藏内容：</span><p>" + a + "</p></div>");
}
...
/**检查服务器是否有付费可见订单 */
function check_pay_view(a, b) { //文章ID，订单号
    var ajax_data = {
...
/**选择那个支付 */
function pay_way(a,b,c) { //id,money,action
