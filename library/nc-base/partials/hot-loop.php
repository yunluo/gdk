...
================================
  	...
  	@Author: Dami
  	@Date:   2018-11-20 13:22:35
  	@Last Modified by:   Dami
  	@Last Modified time: 2019-08-25 20:55:43
...
$hot_modules = objectToArray( json_decode( $store->request() ) );

if( isset( $hot_modules['status'] ) && $hot_modules['status'] == 200 ){
	foreach ($hot_modules['modules'] as $key => $value) {
...
<?php 
	...
	echo '<p class="no-themes" style="display: block;">暂无热门积木。</p>';
}
?>
