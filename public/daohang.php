...
function gdk_get_the_link_items($id = null)
{
    ...
    if (!empty($bookmarks)) {
		...
		$icon = 'https://img12.360buyimg.com/ddimg/jfs/t1/130599/4/13000/527/5f8ef17aE60de6b3e/4da08e59f8e12dec.png';
		}else{
...
/* @media screen and (max-width:767px){.sidenav .nav-tags{display:none !important}}
@media screen and (min-height:900px){}
@media screen and (min-height:760px) and (max-height:899px){.sidenav .nav-tags{max-height:320px} } */
/*@media screen and (min-height:630px) and (max-height:759px){.sidenav .nav-tags{max-height:200px}}*/
/*@media screen and (max-height:629px){.sidenav .nav-tags{max-height:0}}*/
